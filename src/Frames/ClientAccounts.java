...
public class ClientAccounts extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ClientAccounts
     */
    ...
    private void displayClientData() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT username, last_name, first_name, phone_number, email_address FROM user_account");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Last Name", "First Name", "Phone Number", "Email Address"
            }
        ) {
